      ...
      <div className="sticky top-30 left-0">
        ...
        <ul>
          <li
            ...
            } hover:bg-secondary hover:text-white text-gray-700`}
          >
          ...
          {PredefinedCategoriesData.map((cat) => (
            <li
              key={cat.category_id}
              className={`cursor-pointer mb-2 rounded pl-4 pr-2 py-2 ${
                selectedCategory === cat.category_id ? "font-bold" : ""
              } hover:bg-secondary hover:text-white text-gray-700`}
            >
              <Link href={`/products?category=${cat.category_id}`}>
